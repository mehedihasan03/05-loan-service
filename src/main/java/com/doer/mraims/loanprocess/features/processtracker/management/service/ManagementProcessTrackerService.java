...
import com.doer.mraims.loanprocess.core.helper.CommonResponseDTO;
...
public class ManagementProcessTrackerService {
    ...
    public CommonObjectResponseDTO<JSONObject> getManagementProcessTrackerByOffice(AuthUser authUser, String officeId) {
        ...
        try {
            ...
            return new CommonObjectResponseDTO<JSONObject>(true, 200, "Data retrieved successfully", data.getJSONObject("map"));
        } catch (Exception e) {
